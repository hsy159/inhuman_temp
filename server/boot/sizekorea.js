...
module.exports = function(app) {
  ...
  var sizekoreaInit = {
    ...
    makedate: new Date(),
    landmark: {
      '01': { part: '머리부위', std: '머리마루점*', eng: 'Vertex' },
      '02': { part: '머리부위', std: '머리옆점*', eng: 'Euryon', rl: true },
      '03': { part: '머리부위', std: '눈살점*', eng: 'Glabella' },
      '04': { part: '머리부위', std: '눈초리점*', eng: 'Ectocanthus' },
      '05': { part: '머리부위', std: '눈확아래점*', eng: 'Inferior Orbitale(Infraorbitale)' },
      '06': { part: '머리부위', std: '귀구슬점*', eng: 'Tragion', rl: true },
      '07': { part: '머리부위', std: '코뿌리점*', eng: 'Sellion(Nasion)' },
      '08': { part: '머리부위', std: '턱끝점*', eng: 'Menton' },
      '09': { part: '머리부위', std: '뒤통수돌출점*', eng: 'Occiput' },
